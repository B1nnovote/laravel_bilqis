            ...
            <div class="card">
                ...
                <div class="card-body">
                   <div class="mb-2">
                                ...
                                <input type="date" class="form-control" name="nama_produk" 
                                value="{{$transaksi->tgl_transaksi}}" disabled>
                            </div>
                             <div class="mb-2">
